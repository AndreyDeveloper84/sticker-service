...
# «Сменить одежду» (revision): the only category that invites optional text.
REVISION_ACCEPTED_TEXT = "Правка принята. Мы подготовим обновлённое превью."
REVISION_CLOTHES_ACCEPTED_TEXT = (
    "Правка принята: сменим одежду. Если хотите — напишите одним сообщением, "
    "во что переодеть (необязательно). Мы подготовим обновлённое превью."
)
REVISION_TEXT_SAVED_TEXT = "Записали: «{text}». Учтём при подготовке нового превью."
