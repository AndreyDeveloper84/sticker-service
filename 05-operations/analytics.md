...
Telegram и MAX анализируются отдельно по конверсии, среднему чеку, отказам, стоимости привлечения при наличии данных, delivery success и повторным заказам.
